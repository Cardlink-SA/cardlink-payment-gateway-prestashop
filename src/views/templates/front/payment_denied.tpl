...
{block name="page_content"}
	...
	<h1 class="page-heading">{l s='Payment was denied' mod='cardlink_checkout'}</h1>

	<p class="warning">
		<strong>{l s='The payment was denied for the card or by the bank.' mod='cardlink_checkout'}</strong>
		{if $error}
			<br /><br />
