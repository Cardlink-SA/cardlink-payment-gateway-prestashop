...
class Constants
{
    ...
    public const TABLE_NAME_TRANSACTIONS = 'cardlink_payment_transactions';
    ...
    public const ENABLE_GOOGLEPAY = false;
    public const ENABLE_APPLEPAY = false;
    public const CONFIG_GOOGLEPAY_ENABLE = 'CARDLINK_CHECKOUT_CONFIG_GOOGLEPAY_ENABLE';
    public const CONFIG_GOOGLEPAY_TITLE = 'CARDLINK_CHECKOUT_CONFIG_GOOGLEPAY_TITLE';
    public const CONFIG_GOOGLEPAY_DESCRIPTION = 'CARDLINK_CHECKOUT_CONFIG_GOOGLEPAY_DESCRIPTION';
    public const CONFIG_GOOGLEPAY_BUSINESS_PARTNER = 'CARDLINK_CHECKOUT_CONFIG_GOOGLEPAY_BUSINESS_PARTNER';
    public const CONFIG_GOOGLEPAY_MERCHANT_ID = 'CARDLINK_CHECKOUT_CONFIG_GOOGLEPAY_MERCHANT_ID';
    public const CONFIG_GOOGLEPAY_SHARED_SECRET = 'CARDLINK_CHECKOUT_CONFIG_GOOGLEPAY_SHARED_SECRET';
    public const CONFIG_GOOGLEPAY_TRANSACTION_ENVIRONMENT = 'CARDLINK_CHECKOUT_CONFIG_GOOGLEPAY_TRANSACTION_ENVIRONMENT';
    public const CONFIG_GOOGLEPAY_DISPLAY_LOGO = 'CARDLINK_CHECKOUT_CONFIG_GOOGLEPAY_DISPLAY_LOGO';
    public const CONFIG_GOOGLEPAY_MPI_PRIVATE_KEY = 'CARDLINK_CHECKOUT_CONFIG_GOOGLEPAY_MPI_PRIVATE_KEY';
    public const CONFIG_GOOGLEPAY_3DS_UI_MODE = 'CARDLINK_CHECKOUT_CONFIG_GOOGLEPAY_3DS_UI_MODE';

    // Apple Pay config keys
    public const CONFIG_APPLEPAY_ENABLE = 'CARDLINK_CHECKOUT_CONFIG_APPLEPAY_ENABLE';
    public const CONFIG_APPLEPAY_TITLE = 'CARDLINK_CHECKOUT_CONFIG_APPLEPAY_TITLE';
    public const CONFIG_APPLEPAY_DESCRIPTION = 'CARDLINK_CHECKOUT_CONFIG_APPLEPAY_DESCRIPTION';
    public const CONFIG_APPLEPAY_BUSINESS_PARTNER = 'CARDLINK_CHECKOUT_CONFIG_APPLEPAY_BUSINESS_PARTNER';
    public const CONFIG_APPLEPAY_MERCHANT_ID = 'CARDLINK_CHECKOUT_CONFIG_APPLEPAY_MERCHANT_ID';
    public const CONFIG_APPLEPAY_SHARED_SECRET = 'CARDLINK_CHECKOUT_CONFIG_APPLEPAY_SHARED_SECRET';
    public const CONFIG_APPLEPAY_TRANSACTION_ENVIRONMENT = 'CARDLINK_CHECKOUT_CONFIG_APPLEPAY_TRANSACTION_ENVIRONMENT';
    public const CONFIG_APPLEPAY_DISPLAY_LOGO = 'CARDLINK_CHECKOUT_CONFIG_APPLEPAY_DISPLAY_LOGO';
    public const CONFIG_APPLEPAY_MPI_PRIVATE_KEY = 'CARDLINK_CHECKOUT_CONFIG_APPLEPAY_MPI_PRIVATE_KEY';
    public const CONFIG_APPLEPAY_3DS_UI_MODE = 'CARDLINK_CHECKOUT_CONFIG_APPLEPAY_3DS_UI_MODE';

    public const THREE_DS_UI_MODE_REDIRECT = 'redirect';
    public const THREE_DS_UI_MODE_IFRAME_MODAL = 'iframe_modal';
